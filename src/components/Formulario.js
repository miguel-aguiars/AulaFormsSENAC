...
onChange={(e) => setUsername(e.target.value)} //evento onChange adicionado
required
/>
<div className="inputfield">
...
placeholder={email} 
onChange={(e) => {
validateEmail(); setEmail(e.target.value);
}}
/>
...
<select id="selform"
onChange={(e) => setDepartamento(e.target. value)} //evento onChange adicionado
>
<option value="">...</option>
...
onChange={(e) => setMensagem(e.target.value)} //evento onChange adicionado
></textarea>
</div>
</div>
<div className="inputfield">
